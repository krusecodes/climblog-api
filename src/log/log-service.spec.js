  ...
  let testLog = [
    {
      ...
      attempts: 9,
      rating: 5,
      what_i_learned: 'Plan your route before you start'
    },
    {
      id: 2,
      climb_type: 'Bouldering (Indoor)',
  ...
  context(`Given 'climblog_log' has data`, () => {
    ...
    describe(`POST /log`, () => {
      ...
      describe(`DELETE /log/:log_id`, () => {
        ...
        const requiredFields = ['climb_type', 'difficulty', 'attempts', 'rating', 'what_i_learned']
      ...
      describe(`GET /log/:log_id`, () => {
        ...
        context(`Given an XSS attack log`, () => {
          const maliciousLog = {
            ...
            rating: '5',
            what_i_learned: `Bad image <img src="https://url.to.file.which/does-not.exist" onerror="alert(document.cookie);">. But not <strong>all</strong> bad.`
          }
